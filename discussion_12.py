...
def create_employee_table(cur, conn):
    cur.execute("CREATE TABLE IF NOT EXIST Employees Employee_id INT, first_name TEXT, last_name TEXT, hire_date TEXT, job_id INT, salary INT")
    conn.commit()
